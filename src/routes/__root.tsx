...
import { NexusStateProvider } from "../lib/state-engine";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Rural AI — Speak in any language" },
      {
        name: "description",
        content:
          "A voice-first AI companion for rural India. Speak in any language and get help with crops, schemes, documents, health and more.",
      },
